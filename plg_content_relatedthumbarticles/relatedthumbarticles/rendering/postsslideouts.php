...
class CedThumbnailsPostsslideoutsRendering extends JObject
{
    ...
    public function render($entries, $params)
    {
        ...
        if (sizeof($entries) > 0) {
            ...
            foreach ($entries as $entry) {
                $html .= "<li>
                           <div>
                                <a href='" . $entry['link'] . "' alt='" . $entry['title'] . "'>
                                  <img src='" . $entry['imgSrc'] . "'  width='" . $entry['width'] . "' height='" . $entry['height'] . "' alt='" . $entry['title'] . "'/></a>
